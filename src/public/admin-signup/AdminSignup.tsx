...
import { checkAdminExists } from '../../lib/userService'
...
export default function AdminSignup() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            if (adminExists) {
                // Existing admin - go to dashboard
                navigate('/user-dashboard')
            } else {
                // New admin - go to admin signup form
        ...
        <div className="admin-signup-page">
            <div className="admin-signup-container">
                <div className="admin-signup-card">
                    ...
                    <h1 className="admin-signup-title">Admin Sign In</h1>
                    ...
                    <p className="admin-signup-footer-text">
